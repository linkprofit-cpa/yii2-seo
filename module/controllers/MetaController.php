...
//            'query' => SeoPage::find()->where(['OR', ['action_params' => '[]'], ['LIKE', 'action_params', 'slug']])->with(array_keys(SeoMeta::nameList())),
            'query' => SeoPage::find()->where(['action_params' => '[]'])->with(array_keys(SeoMeta::nameList())),
            'pagination' => [
                'pageSize' => 100
            ],
        ]);
